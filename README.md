...
```javascript
import normal from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-normal@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-normal@v0.0.1-deno/mod.js';
```
